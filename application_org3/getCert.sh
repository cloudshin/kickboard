...
cp "${DIR}/../network/organizations/peerOrganizations/org4.example.com/users/User1@org4.example.com/msp/signcerts/"* "${DIR}/msp/org4.example.com/users/signcerts/User1@org4.example.com-cert.pem"
cp "${DIR}/../network/organizations/peerOrganizations/org4.example.com/users/User1@org4.example.com/msp/keystore/"* "${DIR}/msp/org4.example.com/users//keystore/priv_sk"
{ set +x; } 2>/dev/null